...
public class Fly extends Module {
    private final ModeSetting mode = new ModeSetting(this, "Mode", new String[] {"Dev", "Vanilla", "Negativity"});

    FlyBase dev = new FlyDev(), vanilla = new FlyVanilla(), negativity = new FlyNegativity();
